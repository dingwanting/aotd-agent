...
const DEPLOY_VERSION = "aotd-2026-08-01-r30-song-stability-guard-v1";
const STARTUP_MARKER = "aotd-song-stability-guard-v1-2026-08-01";
    ...
    if (
      ...
      try {
        ...
        await userStateStore.appendEvent(fallbackTask.userId, {
          ...
          mode: "demo",
          fallbackReason: isRetryableAotdSongRemoteError(error) ? "remote-fetch-failed" : "remote-provider-failed",
        });
